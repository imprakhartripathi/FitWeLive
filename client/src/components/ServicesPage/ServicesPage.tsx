      ...
      <div className="servicespage">
        ...
        <FadeInSection>
          <section className="description">
            ...
            <p>
              Our plans are not one-size-fits-all. We tailor each service to
              your specific goals, preferences, and physical conditions. From
              carefully structured diet charts to dynamic exercise regimens, we
              support you in building sustainable habits that lead to long-term
              results.
            </p>
            <h3>Disclaimer</h3>
